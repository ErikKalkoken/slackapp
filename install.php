 ...
 * This is a rudimentary example for a script that installs a Slack app with OAuth
 *
 * HISTORY
...
{	
	...
	$slack_call = "https://slack.com/oauth/authorize?scope=$scope";
	$slack_call .= "&client_id=$client_id&redirect_uri=$redirect_uri";
...
//
// This part will be exuectued if Slack returns an error code
//////////////////////////////////////////////////////
